...
class GetGameDetailUseCase @Inject constructor(private val repositoryContract: GameRepositoryContract) {
    operator fun invoke(id: Int): Single<Resource<GameEntity>> {
        return repositoryContract.getGameDetail(id).map {
